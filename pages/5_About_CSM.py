...
st.write("""The China Sanctions Monitor is managed by [Viking Bohman](https://kinacentrum.se/en/our-staff/viking-bohman/) and [Victor Ferguson](https://www.victoraferguson.com/). You can read more about us on [Substack](https://chinasanctionsmonitor.substack.com/).
